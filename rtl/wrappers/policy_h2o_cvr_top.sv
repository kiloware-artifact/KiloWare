...
// H2O-score KCMU plus clean-victim retention (CVR).
//
// This wrapper preserves the lossless H2O-derived score metadata and adds a
// 16-line clean read-only CVR spillway on L2 eviction. It corresponds to the
// paper row `H2O + victim cache`.
module policy_h2o_cvr_top #(
